...
function imgui.OnDrawFrame()
    ...
    if update_menu.v then
        ...
        imgui.Begin(u8 "Настройки обнолвения. Версия скрипта: " .. script_vers_text, update_menu,
            imgui.WindowFlags.NoResize + imgui.WindowFlags.NoScrollbar + imgui.WindowFlags.NoCollapse +
            imgui.WindowFlags.ShowBorders)
        ...
        if status == dlstatus.STATUS_ENDDOWNLOADDATA then
            ...
            if tonumber(updateIni.versInfo.vers) > script_vers then
                ...
                sampAddChatMessage(tag ..
                    ...
                    updateIni.versInfo.vers_text .. ". {FFFFFF}введите /aboutUpdate чтобы увидеть список нововведений.",
                    0xFF0000)
                update_state = true
            else
                sampAddChatMessage(
